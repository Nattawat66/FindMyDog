# Generated by Django 5.2.6 on 2025-09-10 09:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'เจ้าของสุนัข'), ('citizen', 'พลเมืองดี'), ('org_admin', 'แอดมินองค์กร')], default='citizen', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.organization')),
            ],
        ),
        migrations.CreateModel(
            name='DogImage',
